...
spec.homepage     = "http://raywenderlich.com"
  ...
  spec.author             = { "Pavan Kumar" => "pavan11.kumar@paytmmoney.com" }
  # Or just: spec.author    = "Pavan Kumar"
  # spec.authors            = { "Pavan Kumar" => "pavan11.kumar@paytmmoney.com" }
  # spec.social_media_url   = "https://twitter.com/Pavan Kumar"
  ...
  spec.source       = { :git => "https://github.com/pavankumar-n-46/KnobControl.git", :tag => "1.0.0" }
